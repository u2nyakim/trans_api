...
<template>
  <a-row :gutter="16">
    ...
    >
      <a-card class="analysis-chart-card" :bordered="false">
        <div class="ele-text-secondary ele-cell">
          <div class="ele-cell-content">Key-Money token消耗总量统计</div>
          <a-tooltip title="系统总消耗的token数">
            <question-circle-outlined />
          </a-tooltip>
        </div>
        <h1 class="analysis-chart-card-num">
          {{ stat.tokenConsumptionTotal }}
        </h1>
    ...
    >
      <a-card class="analysis-chart-card" :bordered="false">
        <div class="ele-text-secondary ele-cell">
          <div class="ele-cell-content">业务接口请求量</div>
    ...
    >
      <a-card class="analysis-chart-card" :bordered="false">
        <div class="ele-text-secondary ele-cell">
          <div class="ele-cell-content">负载状态</div>
          <ele-tag color="green">日</ele-tag>
        </div>
...
<script lang="ts" setup>
  ...
  const stat = ref({
    tokenConsumptionTotal: 0,
    tokenDayTotal: 0,
    tokenWeekGrowthPercentage: {
      s: 0,
      b: 0,
      percentage: 0
    },
    tokenDayGrowthPercentage: {
      s: 0,
      b: 0,
      percentage: 0
    },
